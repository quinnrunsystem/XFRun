...
using XFRun.UI.iOS.Extensions;
using XFRun.UI.iOS.Renderers.CheckBox;

[assembly: ExportRenderer(typeof(XFRun.UI.Forms.Renderers.CheckBox), typeof(CheckBoxRenderer))]
namespace XFRun.UI.iOS.Renderers.CheckBox
{
    public class CheckBoxRenderer : ViewRenderer<XFRun.UI.Forms.Renderers.CheckBox, CheckBoxView>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<XFRun.UI.Forms.Renderers.CheckBox> e)
        {
